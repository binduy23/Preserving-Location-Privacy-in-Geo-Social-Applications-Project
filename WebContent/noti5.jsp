...
ResultSet rs2=st2.executeQuery("select AES_DECRYPT(lat,'key'),AES_DECRYPT(lon,'key'), AES_DECRYPT(content,'key') from loc_data where id='"+id+"' and ekey='"+key+"' ");
%>
<br><br>
...
<%
	...
	response.sendRedirect("noti4.jsp?id1="+id);
	return;
}
%>
